...
{
    [XmlRoot(ElementName = "KeyboardSpec")]
    ...
    public class XmlLinkKey : XmlKey
    {
        ...
        [XmlElement("Replace")]
        public string ReplaceBoolAsString
        {
            get { return this.Replace ? "True" : "False"; }
            set { this.Replace = XmlUtils.ConvertToBoolean(value); }            
        }
    }
    ...
    {
        // TODO: better name? not ambiguous with "text"
        // should text be "label" ?
        public string Value
        { get; set; }
    }
