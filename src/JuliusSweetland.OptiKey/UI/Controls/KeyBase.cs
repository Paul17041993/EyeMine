...
{
    public abstract class KeyBase : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty KeyDownStateProperty =
            DependencyProperty.Register("KeyDownState", typeof(KeyDownStates), typeof(KeyBase), new PropertyMetadata(default(KeyDownStates)));
        ...
        public static readonly DependencyProperty DisplayShiftDownTextProperty =
            DependencyProperty.Register("DisplayShiftDownText", typeof(bool), typeof(KeyBase), new PropertyMetadata(default(bool)));
        ...
        public static readonly DependencyProperty IsCurrentProperty =
            DependencyProperty.Register("IsCurrent", typeof(bool), typeof(KeyBase), new PropertyMetadata(default(bool)));
        ...
        public static readonly DependencyProperty SelectionProgressProperty =
            DependencyProperty.Register("SelectionProgress", typeof(double), typeof(KeyBase), new PropertyMetadata(default(double)));
        ...
        public static readonly DependencyProperty SelectionInProgressProperty =
            DependencyProperty.Register("SelectionInProgress", typeof(bool), typeof(KeyBase), new PropertyMetadata(default(bool)));
        ...
        public static readonly DependencyProperty WidthSpanProperty =
            DependencyProperty.Register("WidthSpan", typeof(double), typeof(KeyBase), new PropertyMetadata(1d));
        ...
        public static readonly DependencyProperty HeightSpanProperty =
            DependencyProperty.Register("HeightSpan", typeof(double), typeof(KeyBase), new PropertyMetadata(1d));
        ...
        public static readonly DependencyProperty SharedSizeGroupProperty =
            DependencyProperty.Register("SharedSizeGroup", typeof(string), typeof(KeyBase), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty SymbolOrientationProperty =
            DependencyProperty.Register("SymbolOrientation", typeof(SymbolOrientations), typeof(KeyBase), new PropertyMetadata(SymbolOrientations.Top));
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register("Text", typeof(string), typeof(KeyBase), new PropertyMetadata(default(string), TextChanged));
        ...
        public static readonly DependencyProperty CaseProperty =
            DependencyProperty.Register("Case", typeof(Case), typeof(KeyBase), new PropertyMetadata(Case.Settings));
        ...
        public static readonly DependencyProperty ShiftUpTextProperty =
            DependencyProperty.Register("ShiftUpText", typeof(string), typeof(KeyBase),
        ...
        {
            var senderAsKey = sender as KeyBase;
        ...
        // Derived classes will be responsible for setting this via properties
        public abstract KeyValue Value
        {
            get;
            set;
        }
        ...
        public static readonly DependencyProperty UseUnicodeCompatibilityFontProperty =
            DependencyProperty.Register("UseUnicodeCompatibilityFont", typeof(bool), typeof(KeyBase), new PropertyMetadata(default(bool)));
